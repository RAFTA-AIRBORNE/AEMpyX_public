...
if "set" in FileList.lower():
    print("Model files read from dir:  %s" % InModDir)
    mod_files = [InModDir+"A5_Merged.npz"]
...
MergeModels = False
ModelMergeFile = InModDir+"MUN_k1_data_merged.npz"
...
if MergeModels:
    Data = util.merge_data_sets(infile_list=mod_files,
