...
"""
InFileFmt = ".npz"
InModDir = AEMPYX_DATA + "/SGL2023/results/"
print("Data read from dir:  %s" % InModDir)

FileList = "search"  # "search", "read"
SearchStrng = "*FL90*results.npz"
...
PlotDir = AEMPYX_DATA + "/SGL2023/plots/"
...
PlotFmt = [".pdf"]
PDFCatalog = True
PDFStrng = "_all_Catalog.pdf"
if ".pdf" in PlotFmt:
    PDFCatName = PlotDir+"AEM05_Type"+str(PlotType)+PDFStrng
else:
