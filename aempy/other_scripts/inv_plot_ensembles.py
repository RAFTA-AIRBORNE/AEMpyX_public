...
InFileFmt = ".npz"
InModDir ="/home/vrath/AEM_Data/TEST/"
...
if "set" in FileList.lower():
   data_files =[
    "AEM05_Rho_100_1000_100_Thk_100_10_nlyr32_TikhOpt_gcv_Prior1000_Err_a50-m3_Results.npz",
    # "GENESIS_Rho_100_1000_100_Thk_100_10_Z_nlyr32_TikhOpt_gcv2_Prior100_Erm_a50-m1_dtrn2_Results.npz"
   ]
...
for file in data_files:
    ...
    viz.plot_ens_results(
            PlotFile = PlotDir+Filename,
            PlotTitle = file,
            PlotFormat = ["png",], DPI = 400,
            Mod0 = [],
            Depth0 = [],
            ModEns = [],
            Depth = [],
