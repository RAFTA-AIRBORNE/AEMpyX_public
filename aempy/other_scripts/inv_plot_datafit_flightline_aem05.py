...
InModDir = AEMPYX_DATA +"/Projects/LoughGur/proc_delete_PLM3s/results/"
InModDir = AEMPYX_DATA +"/Projects/LoughGur/raw/results/"
...
PdfCatalog = True
if ".pdf" in PlotFmt:
    PdfCat ="LoughGurModelCatalog_raw"
else:
...
for file in data_files:
    ...
    if PlotType in [0, 1]:
        ...
        ax[ii].set_ylabel("nRMS " +ProfUnit, fontsize=Fontsize-1)
    ...
    for F in PlotFmt:
      ...
      matplotlib.pyplot.savefig(PlotDir+FileName+F, dpi=400)
