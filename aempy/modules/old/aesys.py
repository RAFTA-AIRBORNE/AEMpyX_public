...
def get_system_params(System='aem05', OutInfo = True):
    ...
    if System.lower() == 'aem05':
        ...
        fwdcall = ''
        sys.exit('System ' + System + ' not yet implemented! Exit.')

    else:
        sys.exit('System ' + System + ' not implemented! Exit.')
...
'''
    ...
    if numpy.size(Data)==0:
        sys.exit('Survey format for ' + Survey + ' not found!.Exit')
...
def read_aempy(File=None, Format=None, System='aem05', OutInfo=False):
    ...
    if   'npz' in ff:
        ...
        sys.exit('Input format ' + ff + ' not implemented! Exit.')
...
def write_aempy(File=None, Data=None, Format=None, System='aem05',
    ...
    if  'npz' in ff:
        ...
        sys.exit('Output format ' + ff + ' not implemented! Exit.')
...
def write_aempy_ncd(File=None, Data=None, Header='',System='aem05',
    ...
    #         sys.exit('File %s can not be removed' % File)
