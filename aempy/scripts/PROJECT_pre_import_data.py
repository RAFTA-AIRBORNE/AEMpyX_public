...
InDatDir = "/home/vrath/work/Data_Somaye/orig/"
OutDatDir = "/home/vrath/work/Data_Somaye/raw/"
RectCorners = [525000., 5816800., 536000., 5829000.] # StGormans
InSurvey = "A5"
OutStrng = InSurvey+"_rect_somprofs"
###############################################################################
# LoughGur
###############################################################################
# DataSelect = "Rectangle"   # "Polygon", "Intersection", "Union"
...
if 'rec' in DataSelect.lower():
    ...
    if Rect.size != 0:
        ...
        sys.exit('No data found in rectangle!\n')
...
if 'pol' in DataSelect:
    ...
    if Poly.size != 0:
        ...
        sys.exit('No data found in polygon!\n')
...
if ('uni' in DataSelect.lower()) or ('int' in DataSelect.lower()):
    ...
    if Poly.size != 0:
        ...
        sys.exit('No data found in polygons!\n')
...
if 'lines' in DataSelect.lower():
    ...
    if len(flightlines) == 0:
        sys.exit('No lines found from list!\n')
    else:
        Data = flightlines
