...
for filename in dat_files:
    ...
    if 'cut' in Action:
        if len(dat_files)==1:
            ...
            sys.exit(' cut option should only be used for single flight line! Exit.')
    ...
    if 'dec' in Action:
        if Window > 1:
            ...
            sys.exit('Window is 1, no decimation! Exit.')

    if 'spl' in Action:
        # sys.exit('Splitting not yet implemented! Exit.')
        if Step > 1:
            ...
            sys.exit('Step is 1, no decimation! Exit.')
