...
!
      !USE core1d_module
      IMPLICIT NONE
      INTEGER , PARAMETER :: nmods=1, nlyr=5, ndata = 22
      INTEGER js, mode
      REAL*8 alt, &
     ...
     &    mvec(7*nlyr),cmp1,cmp2
      ...
      thk(1:nlyr-1)    = (/10.D0, 10.D0, 10.D0, 20.d0 /)
      res(1:nlyr)      = (/100.d0, 10.d0, 1000.d0,10.d0 ,100.d0/)
      reps(1:nlyr)     = 1.D0
      rmu(1:nlyr)      = 1.D0
      calf(1:nlyr)     = 0.D0
      ctau(1:nlyr)     = 0.D0
      ...
      DO js=0, nmods
             ...
             CALL aemfwd1d_genesis(mode,alt, nlyr,mvec,calc_data)
      ...
      WRITE(*,'(/A/11G12.4/11G12.4)') ' result is: ',calc_data
