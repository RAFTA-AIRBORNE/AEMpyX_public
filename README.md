...
<p align="center">   
   Inversion results for synthetic ensemble of perturbed 3-layers for AEM05 FD data. A **L1** regularization operator was used, with the  weighting parameter chosen by the L-curve method. 
</p>
